...
Usage help is described in `http://example.com/?doc/#tools/twolevels/en/README.md` (replacing `http://example.com/?` by the `baseUrl` of your wiki). The same file can be found also here : https://github.com/J9rem/yeswiki-extension-twolevels/blob/master/docs/en/README.md
...
L'aide sur l'utilisation peut être trouvée sur `http://example.com/?doc/#tools/twolevels/fr/README.md` (en remplaçant `http://example.com/?` par `baseUrl` de votre wiki). Le même fichier peut aussi être trouvé ici : https://github.com/J9rem/yeswiki-extension-twolevels/blob/master/docs/fr/README.md
